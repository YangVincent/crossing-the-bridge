...
const PROOFREADING_EXAMPLES = [
  {
    ...
    examples: [
      ...
      {
        text: "涉及指牵连、牵涉到，参与指参与、协助。",
        errors: [{"text": "涉及", "type": "字词错误", "suggestion": "设计"}],
        explanation: '第一个"涉及"应为"设计"。"涉及"(shè jí)和"设计"(shè jì)是同音近音但意思完全不同的字。"涉及"本身就是"牵连、关联"的意思，所以"涉及指牵连"是同义反复的错误。此处应为"设计指牵连、牵涉到"才合理，后面已经用了"参与"，避免混淆'
      },
      {
        text: "到现在已经有一千多年了。",
        errors: [],
      ...
      {
        text: "这座桥的涉及很精美，体现了古代工匠的智慧。",
        errors: [{"text": "涉及", "type": "字词错误", "suggestion": "设计"}],
        explanation: '根据上下文"精美"、"工匠的智慧"，此处应为"设计"。"涉及"指牵涉到、关联到，"设计"指图样、方案、构思'
      },
      {
        text: "这个项目的涉及范围很广，需要多方协调。",
        errors: [],
        explanation: '此处"涉及"用法正确，指项目涉及的范围。根据上下文"范围很广"、"多方协调"判断'
      },
      {
        text: "参与指参加、参与。",
        errors: [{"text": "参与", "type": "字词错误", "suggestion": "参加"}],
        explanation: '"参与指参加、参与"是同义反复错误。参与本身就包含了参与的意思，第二个参与应该是其他词'
      }
    ]
  },
  {
